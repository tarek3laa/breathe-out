...
class FinPatientsXRayPage_2 extends StatelessWidget {
  FinPatientsXRayPage_2({
    Key key,
  }) : super(key: key);
  @override
    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          ...
          Transform.translate(
            offset: Offset(837.0, 935.0),
            child:
                // Adobe XD layer: 'Classify Disease' (group)
                SizedBox(
              width: 496.0,
              height: 110.0,
              child: Stack(
                children: <Widget>[
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(0.0, 0.0, 496.0, 110.0),
                    size: Size(496.0, 110.0),
                    pinLeft: true,
                    pinRight: true,
                    pinTop: true,
                    pinBottom: true,
                    child:
                        // Adobe XD layer: 'C D Button' (shape)
                        Container(
                      decoration: BoxDecoration(
                        borderRadius: BorderRadius.circular(19.0),
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(77.0, 32.0, 340.0, 48.0),
                    size: Size(496.0, 110.0),
                    fixedWidth: true,
                    fixedHeight: true,
                    child: Text(
...
const String _svg_exysgi =
    '<svg viewBox="877.5 197.5 78.0 1.0" ><path transform="translate(877.5, 197.5)" d="M 0 0 L 78 0" fill="none" stroke="#9cd6b1" stroke-width="4" stroke-miterlimit="4" stroke-linecap="round" /></svg>';
